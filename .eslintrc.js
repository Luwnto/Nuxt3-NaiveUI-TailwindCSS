module.exports = {
  ...
  rules: {
    ...
    // 'array-bracket-spacing': [ 2, 'always' ], // 强制数组中括号前后各有一个空格
    ...
    '@typescript-eslint/no-explicit-any': 'error', // 是否允许使用 any 声明类型
    'vue/multi-word-component-names': 'off', // 允许 vue 使用 index.vue 命名
    'keyword-spacing': [
      'error',
      {
        before: true,
